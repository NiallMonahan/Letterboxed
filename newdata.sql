...
-- TAGS  (moved up so FKs in review_tag / list_tag work)
...
-- REVIEW_TAG (fixed review_id values to 1–10)
...
-- REVIEW_COMMENT (fixed review_id values)
INSERT INTO review_comment (review_id, user_id, comment_text) VALUES
(1, 2, 'I totally agree!'),
(1, 3, 'One of my favorites too!'),
(2, 1, 'I had a different opinion.'),
(3, 5, 'Yes, it was great!');

-- REVIEW_LIKE (fixed review_id values)
